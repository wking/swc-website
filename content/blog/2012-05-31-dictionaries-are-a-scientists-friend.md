...
<p>A dictionary is a data structure that is used to look-up a value given an associated key (i.e. its name). Check out the software carpentry <a href="/4_0/setdict/">lecture</a> on dictionaries for a full and technical introduction. Let's do a quick warm-up with dictionaries in Python:</p>
