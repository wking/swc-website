...
<li>Figure out how to do what we want with the existing <code>script</code> command. <a href="{{root_path}}/blog/2012/07/software-carpentry-needs-you.html">Your help</a> would be appreciated.</li>
