...
<ol>
  ...
  <li><strong>Workshop/participant level mismatch</strong>
    <ul>
      ...
      <li>Telling people <a href="|filename|/about/audience.html">what we expect as background</a>hasn't worked
        <ul>
      ...
      <li>Use a <a href="|filename|2012-10-26-two-self-assessments.md">self-assessment?</a>
        <ul>
