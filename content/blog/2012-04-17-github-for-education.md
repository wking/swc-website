...
<p>Back in December (of 2011), I wondered whether the <a href="|filename|2011-12-30-fork-merge-and-share.md">fork, merge, and share</a> model that underpins so much of modern open source software development could be applied to education. It turns out that lots of other people have been thinking along these lines (and that some of them have actually done something about it):</p>
<ul>
